...
class Problem10(Problem):
    ...
    def solve(self):
        ...
        if (min == 0):
            solution += "Primele " + str(nrPasiUnu) + " respecta cerinta.\n"
        else:
            if min == len(v):
                solution += "Nu s-a gasit nici o solutie pentru a se executa " + str(nrPasiUnu) + " pasi din algoritmul de selectia maximului"
            else:
        ...
        if (min2 == 0):
            solution += "Primele " + str(nrPasiDoi) + " respecta cerinta.\n"
        else:
            if min2 ==len(v):
                solution += "Nu s-a gasit nici o solutie pentru a se executa " +str(nrPasiDoi) + " pasi din algoritmul de selectia minimului"
            else:
